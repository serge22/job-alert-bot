...
import { index, update, store } from '@/routes/feeds';
...
const submit = () => {
    if (isEditMode.value) {
        form.put(update.url(props.feed.id), {
            preserveScroll: true,
        });
    } else {
        form.post(store.url(), {
        ...
        <form @submit.prevent="submit" class="space-y-8">
                ...
                <CardContent>
                    <FieldGroup>
                        ...
                        <Field>
                                ...
                                <SelectTrigger>
                                    <div class="flex flex-wrap gap-1">
                                        ...
                                        >
                                            ...
                                            >
                                                <TagsInputItem
                                                    v-for="value in form.category_ids"
                                                    :key="value"
                                                    :value="value"
                                                >
                                                    <TagsInputItemText>{{
                                ...
                                <SelectContent>
                                    ...
                                    >
                                        <SelectGroup v-if="!category.parent_id">
                                            ...
                                            <SelectItem
                                                v-for="child in getChildCategories(
                                                    category.id,
                                                )"
                                                :key="child.id"
                                                :value="child.id"
                            ...
                            />
                            <FieldDescription>
                                Optional: Select multiple categories to filter
                                jobs. Leave empty to include all categories.
                            </FieldDescription>
                        </Field>
                    </FieldGroup>
                </CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Define keywords and conditions to match relevant jobs
                    </CardDescription>
                </CardHeader>
